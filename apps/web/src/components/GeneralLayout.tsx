...
import { Stethoscope, User, LogOut, Heart, FileText, Briefcase, ShieldCheck, Bell, CalendarDays } from 'lucide-react'
            ...
            <nav className="flex items-center gap-4">
              {isAuthenticated ? (
                ...
                <>
                  <Link
                    to="/doctor/apply"
                    className="hidden text-gray-600 hover:text-primary-600 transition-colors md:inline-flex"
                  >
                    Soy médico
                  </Link>
                  <Link 
